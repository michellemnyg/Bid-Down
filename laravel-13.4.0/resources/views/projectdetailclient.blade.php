...
<head>
    ...
    <title>Detail Proyek - Pembuatan Landing Page | Bid Down</title>
                    ...
                    <table class="table table-custom align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="rank-1">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-success-custom fw-bold shadow-sm w-100">Pilih Pemenang</button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-outline-success-custom fw-bold w-100">Pilih Pemenang</button>
                                </td>
                            </tr>
