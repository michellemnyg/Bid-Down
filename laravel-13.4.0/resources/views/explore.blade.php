...
<head>
    ...
    <title>Eksplorasi Proyek | Bid Down</title>
    ...
    <style>
        ...
        .hero {
            ...
            color: #ffffff;
            padding-bottom: 5rem !important; /* Extra padding for overlapping card */
        }
        ...
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarFreelancer">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-medium gap-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary fw-semibold" href="{{ url('/explore') }}">Eksplor Proyek</a>
                    </li> 
                    <li class="nav-item">
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-9">
                    <h1 class="display-5 fw-bold mb-3 text-white">
                        Eksplorasi Proyek Aktif
                    </h1>
                    <p class="mb-0 fs-5 opacity-75" style="font-weight: 400; line-height: 1.6;">
                        Temukan berbagai peluang proyek yang sedang berjalan. Gunakan filter di bawah untuk mencari proyek yang sesuai dengan keahlian Anda, lalu ajukan penawaran terbaik.
                    </p>
                </div>
            </div>
        </div>
