...
<head>
    ...
    <title>Dashboard Freelancer | Bid Down</title>
    ...
    <style>
        ...
        .stat-icon-send { background: linear-gradient(135deg, #c8a27a, #a68159); color: white; }
        .stat-icon-trophy { background: linear-gradient(135deg, #8b5e3c, #5c3c24); color: white; }
        ...
        /* Highlight baris jika Freelancer kalah bid */
        .row-terkalahkan td {
        ...
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarFreelancer">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-medium gap-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#bid-aktif">Bid Aktif Saya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#proyek-berjalan">Proyek Berjalan</a>
                    </li>
                </ul>
                <div class="d-flex ms-lg-4 mt-3 mt-lg-0 align-items-center gap-3">
                    <a href="{{ url('/profilefreelancer') }}" class="nav-link fw-semibold text-dark hover-link">
                        <i class="bi bi-person-circle text-primary me-1"></i> Andi Setiawan
                    </a>
    ...
    <main class="container-lg py-5">
            ...
            <div class="col-md-4">
                <div class="card stat-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        <div class="stat-icon stat-icon-send">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">
                                    <span class="bg-white text-primary px-2 py-1 rounded shadow-sm border"><i class="bi bi-fire text-danger me-1"></i> Bid Terendah (Leader)</span>
                                </th>
                                <th>Status</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="fw-semibold">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="text-decoration-none hover-link">Pembuatan Landing Page Perusahaan</a>
                                </td>
                                <td class="fw-bold text-success">Rp 2.100.000</td>
                                <td class="text-center fw-bold text-success fs-6">Rp 2.100.000</td>
                                <td><span class="badge badge-soft-success rounded-pill px-3 py-2 fw-semibold">Memimpin</span></td>
                                <td class="text-center">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="btn btn-sm btn-outline-primary fw-medium px-3">Lihat Proyek</a>
                                </td>
                            </tr>
                            <tr class="row-terkalahkan">
                                <td class="fw-semibold">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="text-decoration-none hover-link text-danger">Desain UI/UX Aplikasi Mobile</a>
                                </td>
                                <td class="fw-bold text-danger">Rp 7.000.000</td>
                                <td class="text-center fw-bold text-success fs-6">Rp 6.500.000</td>
                                <td><span class="badge badge-soft-danger rounded-pill px-3 py-2 fw-semibold">Terkalahkan</span></td>
                                <td class="text-center">
                                    <a href="{{ url('/projectdetailfreelancer') }}#biddingarea" class="btn btn-sm btn-primary fw-medium px-3"><i class="bi bi-arrow-down-circle me-1"></i> Ubah Bid</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <section id="proyek-berjalan">
            <div class="d-flex align-items-center gap-2 mb-4">
                ...
                <h4 class="fw-bold mb-0">Proyek yang Sedang Dikerjakan</h4>
            </div>
            <div class="card overflow-hidden">
                <div class="table-responsive">
                    <table class="table table-custom mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td class="fw-semibold">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="text-decoration-none hover-link">Desain Logo Perusahaan Baru</a>
                                </td>
                                <td>
                                    <a href="{{ url('/profileclient') }}" class="text-decoration-none text-primary fw-medium hover-link">PT Jaya Abadi</a>
                                </td>
                                <td class="text-danger fw-semibold small"><i class="bi bi-clock-history"></i> Besok, 17:00 WIB</td>
                                <td class="fw-medium text-dark">Rp 800.000</td>
                                <td class="text-center">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="btn btn-sm btn-success fw-medium px-3"><i class="bi bi-check2-circle me-1"></i> Submit Hasil</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="fw-semibold">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="text-decoration-none hover-link">Video Company Profile 3 Menit</a>
                                </td>
                                <td>
                                    <a href="{{ url('/profileclient') }}" class="text-decoration-none text-primary fw-medium hover-link">CV Maju Bersama</a>
                                </td>
                                <td class="text-secondary-custom small"><i class="bi bi-calendar-event"></i> 20 Okt 2024</td>
                                <td class="fw-medium text-dark">Rp 4.200.000</td>
                                <td class="text-center">
                                    <a href="{{ url('/projectdetailfreelancer') }}" class="btn btn-sm btn-outline-primary fw-medium px-3">Detail Kerja</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
