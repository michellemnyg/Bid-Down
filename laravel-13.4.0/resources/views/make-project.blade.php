...
<head>
    ...
    <title>Posting Proyek Baru | Bid Down</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg py-3">
        <div class="container-lg">
            <a class="navbar-brand fw-bold fs-4 text-primary d-flex align-items-center gap-2" href="{{ url('/dashboardclient') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarClient">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-medium gap-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ url('/dashboardclient') }}#proyek-aktif">Proyek Saya</a>
                    </li>
                </ul>
    ...
    <main class="container-lg py-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h2 class="fw-bold mb-1"><i class="bi bi-plus-circle text-primary me-2"></i>Posting Proyek Baru</h2>
                <p class="text-secondary-custom mb-0">Isi detail pekerjaan dengan jelas agar freelancer dapat memberikan penawaran terbaik.</p>
            </div>
        ...
        <form action="{{ route('projects.store') }}" method="POST">
            ...
            <div class="card section-card">
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="projectTitle" name="title" value="{{ old('title') }}" placeholder="Contoh: Pembuatan Website E-Commerce Toko Baju" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control" id="projectDesc" name="description" rows="6" placeholder="Jelaskan secara detail apa yang Anda butuhkan, fitur yang diinginkan, dan ekspektasi hasil akhir..." required>{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="maxPrice" name="max_price" value="{{ old('max_price') }}" placeholder="5000000" min="0" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" id="bidDeadline" name="bid_deadline" value="{{ old('bid_deadline') }}" required>
                        </div>
                    </div>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-end gap-3 mt-4 mb-5">
                ...
                <button type="submit" class="btn btn-primary px-5 py-2 fs-6 shadow-sm">
                    <i class="bi bi-rocket-takeoff me-2"></i> Terbitkan Proyek
                </button>
            </div>
