            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <span class="badge border border-light text-white px-3 py-2 rounded-pill fw-medium mb-4" style="background: rgba(255,255,255,0.1); backdrop-filter: blur(4px);">
                        <i class="bi bi-lightning-charge-fill me-2"></i>Platform Reverse Bidding Pertama di Indonesia
                    </span>
    ...
    <section id="latest-projects" class="py-5 bg-surface border-top border-light">
        <div class="container-lg py-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-5">
                ...
                <a href="{{ url('/explore') }}" class="btn btn-outline-primary fw-medium mt-3 mt-md-0 d-inline-flex align-items-center gap-2">
            ...
            <div class="row align-items-center">
                <div class="col-md-4 text-center text-md-start mb-4 mb-md-0">
                    <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mb-2">
                        <img src="{{ asset('assets/images/icon.svg') }}" alt="Bid-Down Logo" height="24" onerror="this.src='data:image/svg+xml;charset=UTF-8,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'%238b5e3c\'%3E%3Cpath d=\'M13 10V3L4 14h7v7l9-11h-7z\'/%3E%3C/svg%3E';">
